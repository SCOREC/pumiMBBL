...
int main( int argc, char* argv[] )
{
  Kokkos::initialize( argc, argv );
  {
    ...
    ./pumiMBBL2D_Demo 1 -0.5 "uniform" "1.0" "100" "0.01" "NA" 1 -0.5 "uniform" "1.0" "100" "0.01" "NA" "1" 
    */
    ...
    if (test0){
        printf("push-test-0\n");
        printf("lamb-oseen vortex profile\n");
        ...
        for (int istep=0; istep<N_step; istep++){
            ...
            Kokkos::parallel_for("particle-push-test-0", N_part, KOKKOS_LAMBDA (int ipart) {
                ...
                if (part_active){
                    ...
                    pumi::Vector3 velocity = lamb_oseen_vortex(pumi::Vector3(q1,q2,0));
                    double dt = 0.2;
