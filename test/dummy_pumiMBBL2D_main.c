...
int main(int argc, char *argv[])
{
    ...
    if (argc != 11){
      ...
      printf("  E.g.#1\n\n");
      printf("    ./install/bin/pumiMBBL2D_Demo 4 \"leftBL,uniform,uniform,rightBL\" \"20,30,30,20\" \"15,20,20,15\" \"1.0,0,0,1.0\" 3 \"bottomBL,uniform,topBL\" \"10,30,10\" \"5,10,5\" \"1.0,0,1.0\"\n\n");
      printf("  E.g.#2\n\n");
